...
func (_e *IDataChannel_Expecter) CalculateRetransmissionTimeout(_a0 interface{}, streamingMessage interface{}) *IDataChannel_CalculateRetransmissionTimeout_Call {
	return &IDataChannel_CalculateRetransmissionTimeout_Call{Call: _e.mock.On("CalculateRetransmissionTimeout", _a0, streamingMessage)}
}

func (_c *IDataChannel_CalculateRetransmissionTimeout_Call) Run(run func(_a0 log.T, streamingMessage datachannel.StreamingMessage)) *IDataChannel_CalculateRetransmissionTimeout_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(log.T), args[1].(datachannel.StreamingMessage))
	})
	return _c
}
...
func (_c *IDataChannel_CalculateRetransmissionTimeout_Call) RunAndReturn(run func(log.T, datachannel.StreamingMessage)) *IDataChannel_CalculateRetransmissionTimeout_Call {
	_c.Run(run)
	return _c
}
...
func (_e *IDataChannel_Expecter) Initialize(_a0 interface{}, clientId interface{}, sessionId interface{}, targetId interface{}, isAwsCliUpgradeNeeded interface{}) *IDataChannel_Initialize_Call {
	return &IDataChannel_Initialize_Call{Call: _e.mock.On("Initialize", _a0, clientId, sessionId, targetId, isAwsCliUpgradeNeeded)}
}

func (_c *IDataChannel_Initialize_Call) Run(run func(_a0 log.T, clientId string, sessionId string, targetId string, isAwsCliUpgradeNeeded bool)) *IDataChannel_Initialize_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(log.T), args[1].(string), args[2].(string), args[3].(string), args[4].(bool))
	})
	return _c
}
...
func (_c *IDataChannel_Initialize_Call) RunAndReturn(run func(log.T, string, string, string, bool)) *IDataChannel_Initialize_Call {
	_c.Run(run)
	return _c
}
...
//   - input []byte
//   - inputType int
func (_e *IDataChannel_Expecter) SendMessage(_a0 interface{}, input interface{}, inputType interface{}) *IDataChannel_SendMessage_Call {
	return &IDataChannel_SendMessage_Call{Call: _e.mock.On("SendMessage", _a0, input, inputType)}
}

func (_c *IDataChannel_SendMessage_Call) Run(run func(_a0 log.T, input []byte, inputType int)) *IDataChannel_SendMessage_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *IDataChannel_SendMessage_Call) RunAndReturn(run func(log.T, []byte, int) error) *IDataChannel_SendMessage_Call {
	_c.Call.Return(run)
	return _c
}
