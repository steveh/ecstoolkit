...
func (_c *IDataChannel_Open_Call) Return(_a0 string, _a1 error) *IDataChannel_Open_Call {
...
// RegisterOutputStreamHandler provides a mock function with given fields: handler, sessionSpecific
func (_m *IDataChannel) RegisterOutputStreamHandler(handler datachannel.OutputStreamDataMessageHandler, sessionSpecific bool) {
	_m.Called(handler, sessionSpecific)
}
...
func (_e *IDataChannel_Expecter) RegisterOutputStreamHandler(handler interface{}, sessionSpecific interface{}) *IDataChannel_RegisterOutputStreamHandler_Call {
	return &IDataChannel_RegisterOutputStreamHandler_Call{Call: _e.mock.On("RegisterOutputStreamHandler", handler, sessionSpecific)}
}

func (_c *IDataChannel_RegisterOutputStreamHandler_Call) Run(run func(handler datachannel.OutputStreamDataMessageHandler, sessionSpecific bool)) *IDataChannel_RegisterOutputStreamHandler_Call {
	_c.Call.Run(func(args mock.Arguments) {
